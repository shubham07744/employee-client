...
const Login = () => {
    ...
    const handleSubmit = async(e)=>{
        e.preventDefault()
        try {
            const response = await axios.post("https://employee-server-one.vercel.app/api/auth/login",{email, password});
  ...
  return (
    <div className='flex flex-col items-center h-screen justify-center bg-gradient-to-b from-teal-600 from-50% to-orange-200 to-50% space-y-6'>
        <h2 className='font-pacific text-3xl text-amber-900'>Employee Management System</h2>
