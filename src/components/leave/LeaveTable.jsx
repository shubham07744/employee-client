...
const LeaveTable = () => {
    ...
    const fetchLeaves = async()=>{
        try{
            const response = await axios.get('https://employee-server-one.vercel.app/api/leave',{
              headers:{
    ...
    <div className='p-6'>
        ...
        <div className='flex justify-between items-center'>
            ...
            <div className='space-x-3'>
                <button className='px-2 py-1 bg-emerald-600 text-white hover:bg-yellow-700'
                onClick={()=>filterByButton("Pending")}>Pending</button>
                <button className='px-2 py-1 bg-emerald-600 text-white hover:bg-blue-700'
                onClick={()=>filterByButton("Approved")}>Approved</button>
                <button className='px-2 py-1 bg-emerald-600 text-white hover:bg-red-700'
